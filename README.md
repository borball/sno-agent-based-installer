...
This repo provides set of helper scripts for SNO deployment:
...
- sno-day2: Used to apply [day2 configurations](https://github.com/openshift-kni/cnf-features-deploy/tree/release-4.12/ztp/gitops-subscriptions/argocd/example/policygentemplates) required by vDU.
