...
echo
echo "Installing..."
until curl --silent http://[2600:52:7:58::48]:8090/api/assisted-install/v2/clusters |jq '.[].status' |grep -m 1 "installing"; do
  curl --silent http://[2600:52:7:58::48]:8090/api/assisted-install/v2/clusters |jq
  sleep 5
done
